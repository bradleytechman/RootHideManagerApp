...
This iPA in releases does work, as the page this project is forked from doesn't.

Compatible with
- iOS14 (use varClean14, rootful)
- iOS15+ (use varClean15, rootless) *Verified to be working with iOS **15**, **16** and **17***
